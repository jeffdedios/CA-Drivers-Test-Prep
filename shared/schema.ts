...
export const questions = pgTable("questions", {
  ...
  options: jsonb("options").$type<string[]>().notNull(), // Array of 4 answer options
  correctAnswer: integer("correct_answer").notNull(), // Index 0-3
  explanation: text("explanation").notNull(),
  section: varchar("section").default(""), // Which section of handbook
...
export const studySessions = pgTable("study_sessions", {
  ...
  category: varchar("category").default("all"), // all, signs, laws, safety, alcohol
